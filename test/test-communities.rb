  ...
  test('#each') do
    ...
    assert_equal([
                    1994,
                    {
                      ...
                      :rent_high_q => 0.38,
                      :med_rent => 0.34,
                      :med_rent_percent_hous_inc => 0.38,
                      :med_own_cost_percent_inc => 0.46,
                      :med_own_cost_percent_inc_no_mtg => 0.25,
                    ...
                    },
                    {
                      ...
                      :rent_high_q => 0.61,
                      :med_rent => 0.54,
                      :med_rent_percent_hous_inc => 0.69,
                      :med_own_cost_percent_inc => 0.73,
                      :med_own_cost_percent_inc_no_mtg => 0.21,
