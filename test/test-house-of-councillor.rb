class HouseOfCouncillorTest < Test::Unit::TestCase
  ...
  sub_test_case(":in_house_group") do
    ...
    test("#each") do
      ...
      assert_equal([
                     13,
                     record(Date.parse("2026-02-18"),
                            "自由民主党・無所属の会",
                            "自民",
                            Date.parse("2026-05-03"),
                            101,
                            20,
    ...
    test("#each") do
      ...
      assert_equal([
                     ...
                     record("青木　愛",
                            ...
                            [2007, 2016, 2022],
                            3,
                            "外交防衛委員会（理）、行政監視委員会、政府開発援助及び国際協力・人道支援等に関する特別委員会",
                            Date.parse("2026-05-03"),
    ...
    test("#each") do
      ...
      assert_equal([
                     ...
                     record(221,
                            ...
                            nil,
                            nil,
                            "https://www.sangiin.go.jp/japanese/joho1/kousei/syuisyo/221/meisai/m221042.htm",
